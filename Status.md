...
- [chrisburel/perlqt](https://github.com/chrisburel/perlqt) seems to depend
  on SMOKE binding generated by [chrisburel/smokegen](https://github.com/chrisburel/smokegen) which seems to be abandoned in September 2019. It seems like it was trying to use clang tooling libraries to port SMOKE bindings from Qt4 to Qt5, but maybe it became too difficult to do that? 
